...
import { ArrowLeft, Bell, Upload, FileText, Receipt, Euro, AlertTriangle, BarChart3, CheckCircle2 } from "lucide-react";
              ...
              <div className="bg-card rounded-2xl p-5 card-shadow flex flex-col gap-3">
                ...
                <div className="space-y-1 text-xs text-muted-foreground">
                  {(transactions as Record<string, unknown>[])
                    ...
                    .slice(0, 3)
                    .map((t) => (
                      <div key={t.id} className="flex items-center justify-between border rounded-xl px-2 py-1">
                ...
                <div className="bg-card rounded-2xl p-5 card-shadow flex flex-col gap-3 md:col-span-2">
                  ...
                  {constructionStats.totalJobCost > 0 ? (
                    ...
                    <div className="h-24 flex items-center justify-center text-xs text-muted-foreground">
                      Once you categorise expenses as Materials, Labour, Subcontractors and Fuel, we'll show your job
                      cost mix here.
                    </div>
                  )}
                </div>
