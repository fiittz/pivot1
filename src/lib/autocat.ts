...
export const CATEGORY_NAME_MAP: Record<string, string[]> = {
  // ── Expense categories ──
  "Motor Vehicle Expenses": ["Motor & Travel", "Motor Fuel", "Vehicle Expenses", "Fuel", "Vehicle Maintenance & Repairs", "Travel & Subsistence", "Travel & Accommodation"],
  "Motor/travel": [
    "Motor & Travel",
    "Motor Fuel",
    "Van Costs",
  ...
  Software: ["Computer Costs", "Subscriptions & Software", "Software & Licenses", "Printing, Postage & Stationery", "Office Expenses"],
  "Cloud Hosting": [
  ...
  Phone: ["Telephone & Communications", "Telephone & Internet", "Computer Costs", "Subscriptions & Software"],
  ...
  "Director's Salary": ["Director's Remuneration", "Director's Salary", "Wages & Salaries", "Staff Wages"],
  Dividends: ["Dividends"],
  "Meals & Entertainment": ["Meals & Entertainment"],
  "Consulting & Accounting": ["Professional Fees"],
  Wages: ["Subcontractor Costs", "Wages & Salaries", "Subcontractor Payments", "Staff Wages", "Contractor Payments", "Driver Wages"],
  "Labour costs": ["Subcontractor Costs", "Wages & Salaries", "Subcontractor Payments", "Staff Wages", "Contractor Payments"],
  "Sub Con": ["Subcontractor Costs", "Subcontractor Payments", "Contractor Payments"],
  ...
  Subsistence: ["Travel & Subsistence", "Subsistence", "Travel & Accommodation", "Meals & Entertainment"],
  Workwear: ["Protective Clothing", "Protective Clothing & PPE"],
  "Tolls & Parking": ["Tolls & Parking", "Motor & Travel", "Vehicle Expenses", "Travel & Subsistence", "Travel & Accommodation"],
  ...
  Office: ["Printing, Postage & Stationery", "Office Expenses", "Computer Costs", "Subscriptions & Software"],
  other: [],
  // Waste
  Waste: [],
  ...
  // Travel & Subsistence
  "Travel & Subsistence": ["Travel & Subsistence", "Travel & Accommodation", "Motor & Travel", "Vehicle Expenses"],
