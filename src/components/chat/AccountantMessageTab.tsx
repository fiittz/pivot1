...
import { useDirectMessages, useSendDirectMessage, useMarkMessagesRead } from "@/hooks/accountant/useDirectMessages";
import { supabase } from "@/integrations/supabase/client";
import { useQueryClient } from "@tanstack/react-query";
import { Send, Loader2 } from "lucide-react";
import { format } from "date-fns";

interface AccountantMessageTabProps {
  accountantClientId: string;
}

export default function AccountantMessageTab({ accountantClientId }: AccountantMessageTabProps) {
